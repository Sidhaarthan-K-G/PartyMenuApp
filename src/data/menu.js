...
const nonVegIcon =
  "https://upload.wikimedia.org/wikipedia/commons/7/7e/Non_veg_symbol.svg";
...
const menuData = [
...

  {
    ...
    ingredients: [
      ...
      { name: "Garlic Sauce", quantity: "50ml" }
    ]
  },
...

  {
    ...
    ingredients: [
      ...
      { name: "Bread Crumbs", quantity: "80g" }
    ]
  },
...

  {
    ...
    description: "Soft paneer cubes cooked in rich creamy gravy.",
    category: "Main Course",
    type: "veg",
    foodIcon: vegIcon,
    imageUrl:
...

  {
    id: 8,
    name: "Mutton Curry",
    description: "Slow-cooked spicy mutton curry with Indian spices.",
    category: "Main Course",
    type: "nonveg",
    foodIcon: nonVegIcon,
    imageUrl:
...

  {
    ...
    description: "Rich chocolate brownie served with chocolate syrup.",
    category: "Dessert",
    type: "veg",
    foodIcon: vegIcon,
    imageUrl:
...

  {
    ...
    description: "Vanilla ice cream topped with nuts and syrup.",
    category: "Dessert",
    type: "veg",
    foodIcon: vegIcon,
    imageUrl:
    ...
    ingredients: [
      ...
      { name: "Chocolate Syrup", quantity: "40ml" }
    ]
  },

  {
    ...
    ingredients: [
      ...
      { name: "Strawberries", quantity: "50g" }
    ]
  },

  {
    ...
    ingredients: [
      { name: "Milk Powder", quantity: "150g" },
...

  {
    ...
    description: "Crispy chicken nuggets served with ketchup.",
    category: "Sides",
    type: "nonveg",
    foodIcon: nonVegIcon,
    imageUrl:
